...
namespace RingSoft.DataEntryControls.NorthwindApp
{
    public class AppDbMaintenanceUserControlProcessor : DbMaintenanceUserControlProcessor
    {
        ...
        public AppDbMaintenanceUserControlProcessor(DbMaintenanceViewModelBase viewModel, Control buttonsControl, DbMaintenanceUserControl userControl, DbMaintenanceStatusBar statusBar, IUserControlHost host) : base(viewModel, buttonsControl, userControl, statusBar, host)
        {
