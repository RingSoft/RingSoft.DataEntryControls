...
namespace RingSoft.DataEntryControls.Tests.NumericProcessorTests
{
    ...
    public class CurrencyTests
    {
        ...
        public void CurrencyNumber_StraightDataEntry()
        {
            ...
            Assert.AreEqual((double)1234.5, processor.Value, "First Decimal Digit Value");
            ...
            Assert.AreEqual((double)1234.56, processor.Value, "Second Decimal Digit Value");
        }
        ...
        public void CurrencyNumber_MiddleReplace()
        {
            ...
            Assert.AreEqual((double)1667.89, processor.Value, "Middle Replace Value");
            ...
            Assert.AreEqual((double)16767.89, processor.Value, "Middle Replace Add First Digit Value");
            ...
            Assert.AreEqual((double)167867.89, processor.Value, "Middle Replace Add Second Digit Value");
            ...
            Assert.AreEqual((double)1678967.89, processor.Value, "Middle Replace Add Third Digit Value");
        }
        ...
        public void CurrencyNumber_MiddleReplace1()
        {
            ...
            Assert.AreEqual((double)16567.89, processor.Value, "Middle Replace1 Value");
            ...
            Assert.AreEqual((double)167567.89, processor.Value, "Middle Replace1 Add First Digit Value");
            ...
            Assert.AreEqual((double)1678567.89, processor.Value, "Middle Replace1 Add Second Digit Value");
        }
        ...
        public void CurrencyNumber_MiddleReplace2()
        {
            ...
            Assert.AreEqual((double)16567.89, processor.Value, "Middle Replace2 Value");
        }
        ...
        public void CurrencyNumber_AddDigitBeforeCurrencySymbol()
        {
            ...
            Assert.AreEqual((double)11234567.89, processor.Value, "Add Digit Before Currency Symbol");
            ...
            Assert.AreEqual(4, control.SelectionStart, "Add Digit Before Currency Symbol");
            Assert.AreEqual((double)6234567.89, processor.Value, "Add Digit Before Currency Symbol");
        }
        ...
        public void CurrencyNumber_AddDigitAfterSuffixCurrencySymbol()
        {
            ...
            Assert.AreEqual((double)1234567.89, processor.Value, "Add Digit After Suffix Currency Symbol");
