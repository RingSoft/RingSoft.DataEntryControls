...
namespace RingSoft.DataEntryControls.Tests.NumericProcessorTests
{
    ...
    public class CurrencyTests
    {
        ...
        public void CurrencyNumber_AddDigitBeforeCurrencySymbol()
        {
            ...
            Assert.AreEqual(4, control.SelectionStart, "Add Digit Before Currency Symbol");
            Assert.AreEqual(6234567.89, (double)processor.Value, "Add Digit Before Currency Symbol");
        }
        ...
        public void CurrencyNumber_AddDigitAfterSuffixCurrencySymbol()
        {
            ...
            Assert.AreEqual(1234567.89, (double)processor.Value, "Add Digit After Suffix Currency Symbol");
            ...
            Assert.AreEqual(12345676, (double)processor.Value, "Add Digit After Suffix Currency Symbol");
        }
    }
}
